...
section .bss
	...
	bar_char resb 3					;Variable que almacena los caracteres ASCII del caracter de barra
...
found0: 							;Se encarga de obtener la informacion despues del ':' y almacenarla en la variable correcta
	...
	inc rsi							;Este caracter es de tres bytes por lo que se continua sacando la informacion
	mov al, [rsi]
	mov [bar_char+1], al
	inc rsi
	mov al, [rsi]
	mov [bar_char+2], al
	inc rsi
	jmp find_colon1						;Una vez que se sacan los 3 bytes. Se procede a la siguiente linea
